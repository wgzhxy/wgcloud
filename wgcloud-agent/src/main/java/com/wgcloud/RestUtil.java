...
/**
 * @version V2.3 @ClassName:RestUtil.java
 * @author: wgcloud
 * @date: 2019年11月16日 @Description: RestUtil.java @Copyright: 2017-2021 www.wgstart.com. All rights
 *     reserved.
 */
@Component
public class RestUtil {
  ...
  public String post(String url, JSONObject jsonObject) {
    ...
    HttpEntity<String> httpEntity =
        new HttpEntity<>(JSONUtil.parse(jsonObject).toString(), headers);
