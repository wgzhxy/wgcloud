...
/**
 * @version V2.3 @ClassName:ScheduledTask.java
 * @author: wgcloud
 * @date: 2019年11月16日 @Description: ScheduledTask.java @Copyright: 2017-2021 www.wgstart.com. All
 *     rights reserved.
 */
@Component
public class ScheduledTask {
  ...
  static ThreadPoolExecutor executor =
      new ThreadPoolExecutor(5, 10, 2, TimeUnit.MINUTES, new LinkedBlockingDeque<>());
  ...
  public void appInfoListTask() {
    ...
    try {
      ...
      String resultJson =
          restUtil.post(commonConfig.getServerUrl() + "/wgcloud/appInfo/agentList", paramsJson);
      if (resultJson != null) {
