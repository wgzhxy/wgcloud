...
/**
 * @version V2.3 @ClassName:SigarUtil.java
 * @author: wgcloud
 * @date: 2019年11月16日 @Description: SigarUtil.java @Copyright: 2017-2021 www.wgstart.com. All rights
 *     reserved.
 */
public class SigarUtil {
  ...
  private static CommonConfig commonConfig =
      (CommonConfig) ApplicationContextHelper.getBean(CommonConfig.class);
